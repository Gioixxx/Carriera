...
- Sistema "satisfaction" (`lib/career/satisfaction.ts`, 2026-08-06): Hall of Fame sull'archivio multi-carriera, record personali, milestone OVR, titoli di stagione — **non ancora verificato end-to-end nel browser**, vedi [[tech-debt]]. Il commit `b13fac9` (record infranti) non è ancora pushato su `origin/main`.
